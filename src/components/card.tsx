...
export const Card: FC = () => {
    return (
        <div className="flex flex-col w-[160px] sm:max-w-none sm:w-[200px] h-60 sm:h-64 p-2 space-y-2 bg-card rounded-3xl border border-border/50 shadow-xs shadow-black/5 hover:scale-105 transition-transform duration-150 ease-in-out cursor-pointer" data-card>
            <img className="h-2/3 w-full object-cover rounded-2xl" src="https://placehold.co/400" alt="" data-card-image />
